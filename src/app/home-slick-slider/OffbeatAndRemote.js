...
export default function OffbeatAndRemoteSlider({ destination, isDestinationLoading = false }) {
  // console.log("OffbeatAndRemoteSlider++++++++++++", destination);
  return (
    <Slider
      {...ModeSettings}
      ...
      {isDestinationLoading
        ...
        : destination?.filter((destination) =>
            destination.tagInfo.some(
              (tag) => tag.tag === "Offbeat and Remote Adventures"
            )
